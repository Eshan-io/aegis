...
## Supported Versions
Only the most recent version of RoboBot is supported.
...
- Crashing the entire RoboBot instance
- Overloading the instance and therefore making the bot unusable on other servers

The following are explicitly not vulnerabilities inside RoboBot:
...
before a fix is available please create a private report here: https://github.com/Eshan-io/RoboBot/security/advisories
