...
## Supported Versions
Only the most recent version of Aegis is supported.
...
- Crashing the entire Aegis instance
- Overloading the instance and therefore making the bot unusable on other servers

The following are explicitly not vulnerabilities inside Aegis:
...
before a fix is available please create a private report here: https://github.com/Eshan-io/aegis/security/advisories
