...
import LevelCommand from './settings/LevelCommand.js';
import LevelRoleCommand from './settings/LevelRoleCommand.js';
...
const hiddenStandaloneSlashCommands = new Set([
    'strike-purge',
    'purge-invites',
]);
...
export class CommandManager {
    ...
    buildCommands(commands) {
        ...
        for (const command of commands) {
            if (command.supportsSlashCommands() && !hiddenStandaloneSlashCommands.has(command.getName())) {
