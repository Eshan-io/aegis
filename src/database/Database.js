...
import LevelsTableMigration from './migrations/LevelsTableMigration.js';
...
export class Database {
    ...
    async getMigrations() {
        return await asyncFilter([
            ...
            new IndexMigration(this, 'levels', 'guildid_level_xp', ['guildid', 'level', 'xp']),
            new IndexMigration(this, 'levels', 'guildid_xp', ['guildid', 'xp']),
